...
public class EventControllerTest {
    ...
    public void save_event_returns200_andEventResponse() throws Exception {
        mockMvc.perform(post("/events")
                .content("{\"title\": \"New Event\", \"dateTime\": \"2021-01-01T12:00:00\", \"guests\": 1, \"coordinator\": \"Imran\" }")
                .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("title").value("New Event"))
                    .andExpect(jsonPath("dateTime").value("2021-01-01T12:00:00"))
                    .andExpect(jsonPath("guests").value(1))
                    .andExpect(jsonPath("coordinator").value("Imran"));;
    }
    ...
    public void update_event_returns200_andEventResponse() throws Exception {
        ...
        mockMvc.perform(put("/events/"+eventResponse.id)
                        .content("{\"title\": \"New Title\", \"dateTime\": \"2021-01-02T12:00:00\", \"guests\": 18, \"coordinator\": \"Imran\" }")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    @Test
    public void delete_event_returns200_when_event_found() throws Exception {
    ...
    @Test
    public void delete_event_returns404_when_event_not_found() throws Exception {
        // Delete an event with non-existent ID
        mockMvc.perform(delete("/events/not-found"))
            .andExpect(status().isNotFound());
     }
