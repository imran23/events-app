    ...
    <Dialog open={props.open} onClose={props.setOpen}>
      ...
      <form onSubmit={submitForm}>
        <DialogContent>
          ...
          <TextField autoFocus onChange={updateData} margin="dense" id="coordinator" label="Coordinator" type="text" fullWidth
                     variant="outlined" error={error?.coordinator !== undefined} helperText={error?.coordinator}/>
        </DialogContent>
        <DialogActions>
